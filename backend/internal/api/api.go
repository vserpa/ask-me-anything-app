...
import (
	...
	"github.com/vserpa/ask-me-anything-app/internal/store/pgstore"
...
const (
	...
	MessageSomenthingWentWrong         = "something went wrong"
	MessageInvalidMessageId            = "invalid message id"
	MessageFailedToReactToMessage      = "failed to react to message"
)
...
func (h apiHandler) handleCreateRoom(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		http.Error(w, MessageSomenthingWentWrong, http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleGetRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, MessageInvalidMessageId, http.StatusBadRequest)
		return
	}
...
func (h apiHandler) handleReactToMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, MessageSomenthingWentWrong, http.StatusInternalServerError)
		slog.Error(MessageFailedToReactToMessage, "error", err)
		return
	}
